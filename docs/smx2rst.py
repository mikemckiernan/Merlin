...
class Smx2Rst:
    ...
    def __init__(self, json_file: str):
        ...
        if not os.path.exists(self.data_json_path) or not os.path.isfile(
            ...
            print(
                "File is not found or is not a file: {}".format(self.data_json_path),
                file=sys.stderr,
            )
            sys.exit(1)
    ...
    def to_rst(self, path: str):
        ...
        for container in self.data.keys():
            ...
            table = self.table_as_str(container)
    ...
    # Though I agree with pylint that this needs a refactor...
    # pylint: disable=too-many-locals, too-many-branches, too-many-statements
    def table_as_str(self, container: str) -> typing.List[str]:
        ...
        for idx, release in enumerate(sorted(self.data[container], reverse=True)):
            data = self.data[container][release]
            ...
            for k, v in fields.items():
                ...
                if "field" in v.keys():
                    ...
                    for line in val.split("\n"):
                        ...
                        if len(self.data[container]) - 1 == idx:
                            to_ret[line_no] += "\n"
                        else:
                            to_ret[line_no] += "  "
                        line_no += 1
    ...
    def set_table_dims(self, container: str):
        ...
        # releases = [x for x in self.data[container]]
